...
var workerBlob=new Blob([workerJs],{type:"application/javascript"});function Vkthread(){this.getVersion=function(){return"2.1.0"}}Vkthread.prototype.exec=function(param){var worker=new Worker(window.URL.createObjectURL(workerBlob)),paramObj={fn:param.fn,args:param.args,context:param.context,importFiles:param.importFiles},promise=new Promise(function(resolve,reject){worker.onmessage=function(oEvent){resolve(oEvent.data);worker.terminate()};worker.onerror=function(error){reject(error.message);worker.terminate()}});
